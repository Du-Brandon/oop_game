...
void App::ValidTask() {
    ...
    case player_level::fourth_level:{
        ...
        wall->clear();
        wall->Start(192.0f, -192.0f, -465.0f, 267.0f, 32.0f, -19.0f);
        wall->setwall(glm::vec2 (-363.86f, 73.006f) , glm::vec2(-149.116f , 121.659f));
        wall->setwall(glm::vec2 (-398.523f, -131.287f) , glm::vec2(-364.459f , 124.414f));
        wall->setwall(glm::vec2 (-359.883f,-124.099f) , glm::vec2(-146.449f , -72.8387f));
        ...
        std::shared_ptr<Enemy_1> m_Enemy12 = std::make_shared<Enemy_1>();
